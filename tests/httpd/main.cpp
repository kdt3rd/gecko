...
int safemain( int /*argc*/, char * /*argv*/[] )
{
    ...
    test.resource( "GET", "/exception" ) = []( web::request &,
                                               net::tcp_socket & ) {
