	...
	: _cpp( cpp )
{
	...
	_globals->set_compile( [&]( const std::shared_ptr<func> &f, const std::vector<var_type> &args ) { return this->compile( f, args ); } );
...
var_type cpp_generator::compile( const std::shared_ptr<func> &f, const std::vector<var_type> &types )
{
