...
inline bool is_signed( pod_type t )
{
    switch ( t )
    {
        ...
        case pod_type::INT16:
        case pod_type::INT32:
        case pod_type::INT64: return true;
...
inline bool is_unsigned( pod_type t )
{
    switch ( t )
    {
        ...
        case pod_type::UINT16:
        case pod_type::UINT32:
        case pod_type::UINT64: return true;
...
{
public:
    data_type( void ) : _type( pod_type::UNKNOWN ), _dims( 0 ) {}

    data_type( pod_type t, size_t d ) : _type( t ), _dims( d ) {}
    ...
    void set_dimensions( size_t d ) { _dims = d; }
...
{
    if ( t == U"bool" )
        return pod_type::BOOLEAN;
    if ( t == U"uint8" )
        return pod_type::UINT8;
    if ( t == U"uint16" )
        return pod_type::UINT16;
    if ( t == U"uint32" )
        return pod_type::UINT32;
    if ( t == U"uint64" )
        return pod_type::UINT64;
    if ( t == U"int8" )
        return pod_type::INT8;
    if ( t == U"int16" )
        return pod_type::INT16;
    if ( t == U"int32" )
        return pod_type::INT32;
    if ( t == U"int64" )
        return pod_type::INT64;
    if ( t == U"half" )
        return pod_type::FLOAT16;
    if ( t == U"float" )
        return pod_type::FLOAT32;
    if ( t == U"double" )
        return pod_type::FLOAT64;
    if ( t == U"unknown" )
...
inline std::string
cpp_type_const_ref( const data_type &t, const std::u32string &mod )
{
    std::ostringstream tmp;
    if ( t.dimensions() > 0 )
    {
