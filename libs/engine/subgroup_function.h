...
public:
    ...
    virtual void bind(
        std::vector<std::shared_ptr<subgroup_function>> &,
        subgroup &,
        node & ) = 0;
...
inline bool subgroup_function::is_output( void ) const
{
...
inline size_t subgroup_function::output_index( void ) const { return _out_idx; }

////////////////////////////////////////

inline void subgroup_function::output_index( size_t i ) { _out_idx = i; }
