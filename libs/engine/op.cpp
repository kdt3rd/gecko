...
const std::type_info &null_func::result_type( void ) const
{
    return _info.get();
}
...
size_t null_func::input_size( void ) const { return 0; }

////////////////////////////////////////

any null_func::process(
    graph &, const dimensions &, const std::vector<any> & ) const
{
    return any();
}
