...
public:
    ...
    /// @param c Color of stroke.
    /// @param w Width of stroke.
    void set_stroke( const color &c, dim w )
    {
        _stroke_color = c;
        _stroke_width = w;
    }
    ...
    const color &get_fill_color( void ) const
    {
        precondition( has_fill_color(), "no fill color" );
        return _fill_color;
    }
    ...
    void set_fill_linear( const point &p, const size &s, const gradient &g )
    {
        clear_fill();
        _fill_type = LINEAR;
        new ( &_fill_linear ) linear( p, s, g );
    }
    void set_fill_linear( const point &p, dim w, dim h, const gradient &g )
    {
        set_fill_linear( p, { w, h }, g );
    }

    const point &get_fill_linear_origin( void ) const
    {
        precondition( has_fill_linear(), "no fill linear" );
        return _fill_linear.p;
    }
    const size &get_fill_linear_size( void ) const
    {
        precondition( has_fill_linear(), "no fill linear" );
        return _fill_linear.s;
    }
    const gradient &get_fill_linear_gradient( void ) const
    {
        precondition( has_fill_linear(), "no fill linear" );
        return _fill_linear.grad;
    }
    ...
    void set_fill_radial( const point &p1, dim r1, dim r2, const gradient &g )
    {
        clear_fill();
        _fill_type = RADIAL;
        new ( &_fill_radial ) radial( p1, r1, r2, g );
    }
    void set_fill_radial( const point &p, dim r, const gradient &g )
    {
        set_fill_radial( p, dim( 0 ), r, g );
    }
    const point &get_fill_radial_center( void ) const
    {
        precondition( has_fill_radial(), "no fill radial" );
        return _fill_radial.center;
    }
    dim get_fill_radial_r1( void ) const
    {
        precondition( has_fill_radial(), "no fill radial" );
        return _fill_radial.r1;
    }
    dim get_fill_radial_r2( void ) const
    {
        precondition( has_fill_radial(), "no fill radial" );
        return _fill_radial.r2;
    }
    const gradient &get_fill_radial_gradient( void ) const
    {
        precondition( has_fill_radial(), "no fill radial" );
        return _fill_radial.grad;
    }
    ...
    void set_fill_conical( const point &p, const gradient &g )
    {
        clear_fill();
        _fill_type = CONICAL;
        new ( &_fill_conical ) conical( p, g );
    }
    const point &get_fill_conical_center( void ) const
    {
        precondition( has_fill_conical(), "no fill conical" );
        return _fill_conical.p;
    }
    const gradient &get_fill_conical_gradient( void ) const
    {
        precondition( has_fill_conical(), "no fill conical" );
        return _fill_conical.grad;
    }
    ...
    void set_fill_box(
        const point &p1, const point &p2, dim radius, const gradient &g )
    {
        clear_fill();
        _fill_type = BOX;
        new ( &_fill_box ) box( p1, p2, radius, g );
    }

    const point &get_fill_box_point1( void ) const
    {
        precondition( has_fill_box(), "no fill box" );
        return _fill_box.point1;
    }
    const point &get_fill_box_point2( void ) const
    {
        precondition( has_fill_box(), "no fill box" );
        return _fill_box.point2;
    }
    dim get_fill_box_radius( void ) const
    {
        precondition( has_fill_box(), "no fill box" );
        return _fill_box.radius;
    }
    const gradient &get_fill_box_gradient( void ) const
    {
        precondition( has_fill_box(), "no fill box" );
        return _fill_box.grad;
    }
...
private:
    ...
    struct conical
    {
        conical( const point &pp, const gradient &g ) : p( pp ), grad( g ) {}
