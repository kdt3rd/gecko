...
public:
	...
	std::shared_ptr<font_dpi_cache> get_cache( int dpih, int dpiv, int maxGlyphW, int maxGlyphH );
	...
	virtual std::shared_ptr<font> get_font( const std::string &family, const std::string &style, points pts, int dpih, int dpiv, int maxGlyphW, int maxGlyphH ) = 0;
