...
std::shared_ptr<media::frame> to_frame(
    ...
    const media::metadata &         meta = media::metadata() );
...
void debug_save_image(
    ...
    const std::vector<std::string> &chans,
    const std::string &             type,
    const media::parameter_set &    params = media::parameter_set(),
    const media::metadata &         meta   = media::metadata() );

std::shared_ptr<media::frame> load_frame(
    const std::shared_ptr<media::container> &c,
    size_t                                   videoTrackIdx,
    int64_t                                  sampNum );
plane extract_view_plane(
    const std::shared_ptr<media::frame> &frame,
    const std::string &                  layer,
    const std::string &                  view,
    const std::string &                  p );
image_buf extract_view(
    const std::shared_ptr<media::frame> &frame,
    const std::string &                  layer,
    const std::string &                  view );
...
finish_frame( const std::shared_ptr<media::frame> &frame );
