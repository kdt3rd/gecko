...
plane despeckle(
    const plane &p, float removeBright = 1.F, float removeDark = 1.F );
...
plane savitsky_golay_minimize_error(
    const plane &p, int radius, int max_order );
