...
public:
    ...
    inline const std::vector<parameter_definition> &parameters( void ) const
    {
        return _parms;
    }
    ...
    static parameter_set parameters_by_ext(
        const base::uri &u, const std::string &opts = std::string() );
