...
public:
    ...
    int64_t number( void ) const { return _number; }
    ...
    find_image( base::cstring layer, size_t viewIdx ) const;
    std::shared_ptr<image>
    find_image( base::cstring layer, base::cstring v ) const;
    ...
    std::shared_ptr<data>
    find_data( base::cstring layer, size_t viewIdx ) const;
    std::shared_ptr<data>
    find_data( base::cstring layer, base::cstring v ) const;
    ...
    const_image_iterator image_begin( void ) const
    {
        return const_image_iterator( this );
    }
    const_image_iterator image_end( void ) const
    {
        return const_image_iterator();
    }
    ...
    const_data_iterator data_begin( void ) const
    {
        return const_data_iterator( this );
    }
...
inline frame::const_image_iterator::const_image_iterator( const frame *f )
    : _frame( f ), _cur_layer( 0 ), _cur_view( 0 )
{
    advance( false );
}

inline frame::const_image_iterator &frame::const_image_iterator::
                                    operator++( void )
{
    advance( true );
    return *this;
...
inline bool frame::const_image_iterator::
            operator==( const const_image_iterator &o ) const
{
    return _frame == o._frame && _cur_layer == o._cur_layer &&
           _cur_view == o._cur_view;
}
...
inline const layer &frame::const_image_iterator::access_layer( void ) const
{
    return _frame->layers()[_cur_layer];
}

inline const view &frame::const_image_iterator::access_view( void ) const
{
    return _frame->layers()[_cur_layer][_cur_view];
}

inline image &frame::const_image_iterator::operator*(void)const
{
    return *( static_cast<const std::shared_ptr<image> &>(
        _frame->layers()[_cur_layer][_cur_view] ) );
}

inline void frame::const_image_iterator::advance( bool incfirst )
{
    if ( !_frame )
        return;
...
inline frame::const_data_iterator::const_data_iterator( const frame *f )
    : _frame( f ), _cur_layer( 0 ), _cur_view( 0 )
{
    advance( false );
}

inline frame::const_data_iterator &frame::const_data_iterator::
                                   operator++( void )
{
    advance( true );
    return *this;
...
inline bool frame::const_data_iterator::
            operator==( const const_data_iterator &o ) const
{
    return _frame == o._frame && _cur_layer == o._cur_layer &&
           _cur_view == o._cur_view;
}
...
inline data &frame::const_data_iterator::operator*(void)const
{
    return *( static_cast<const std::shared_ptr<data> &>(
        _frame->layers()[_cur_layer][_cur_view] ) );
}

inline void frame::const_data_iterator::advance( bool incfirst )
{
    if ( !_frame )
        return;
