...
public:
    ...
    explicit inline frame_set_citer( const accessor &a, int64_t point )
        : _a( a ), _cur( point )
    {}
...
inline bool frame_set::empty( void ) const { return _ranges.empty(); }

////////////////////////////////////////

inline bool frame_set::has_gaps( void ) const { return ranges() > 1; }

////////////////////////////////////////

inline size_t frame_set::ranges( void ) const { return _ranges.size(); }
...
inline size_t frame_set::count( void ) const { return _count; }
