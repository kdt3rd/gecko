...
public:
    ...
    public:
        ...
        void vertex_attribute(
            ...
            size_t                       a = 0 )
        {
            _bound.attrib_pointer<Args...>(
                _prog->get_attribute_location( name ), data, a );
        }
    ...
    {
        _prog =
            std::make_shared<program>( s, std::forward<Shaders>( shaders )... );
    }

    bool has_program( void ) { return static_cast<bool>( _prog ); }
