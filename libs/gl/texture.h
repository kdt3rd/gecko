...
public:
    ...
    public:
        ...
        {
            upload_helper(
                f, GL_RED, 1, w, h, type, data, stride_bytes, needswap );
        }
        ...
        {
            upload_helper(
                f, GL_RG, 2, w, h, type, data, stride_bytes, needswap );
        }
        ...
        {
            upload_helper(
                f, GL_RGB, 3, w, h, type, data, stride_bytes, needswap );
        }
        ...
        {
            upload_helper(
                f, GL_RGBA, 4, w, h, type, data, stride_bytes, needswap );
        }
        ...
        void set_swizzle(
            swizzle r, swizzle g, swizzle b, swizzle a = swizzle::ONE );
    ...
    inline bool is_valid( void ) const { return _texture > 0; }
