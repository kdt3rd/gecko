...
public:
    ...
    public:
            ...
            size_t                       a )
        {
            ...
            attrib_pointer(
                attr,
                vbo,
                data.attribute_size( a ),
                data.stride(),
                data.attribute_offset( a ) );
        }
        ...
        {
            precondition(
                !_self->has_element_buffer(),
                "can't draw from index vector without EBO" );
            glDrawElements(
    ...
    bool has_element_buffer( void ) const { return static_cast<bool>( _ebo ); }

    GLuint id( void ) const { return _array; }
