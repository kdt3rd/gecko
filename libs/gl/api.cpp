...
void api::enable( capability cap ) { glEnable( static_cast<GLenum>( cap ) ); }

////////////////////////////////////////

void api::disable( capability cap ) { glDisable( static_cast<GLenum>( cap ) ); }
...
void api::clear( buffer_bit bit ) { clear( static_cast<buffer_bits>( bit ) ); }
...
void api::depth_mask( bool write ) { glDepthMask( write ); }
...
void api::save_matrix( void ) { _matrix.emplace_back( _matrix.back() ); }
...
void api::multiply( const matrix4 &m ) { _matrix.back() *= m; }
