...
rect screen::bounds( bool avail ) const
{
    ...
    return { 0,
             0,
             static_cast<coord_type>( b.size.width * scale ),
             static_cast<coord_type>( b.size.height * scale ) };
}
...
dots_per_unit screen::dpi( void ) const
{
    ...
    return dots_per_unit(
        dots_per_unit::coord_type( dpi.width ),
...
dots_per_unit screen::dpmm( void ) const
{
    ...
    return dots_per_unit(
        inch.w() / dots_per_unit::coord_type( 25.4 ),
