...
public:
	...
	{
	private:
		clip_region_guard( context *c, const rect &r ) : _c( c ) { c->push_clip_rect( r ); }
	...
	public:
		...
		clip_region_guard( clip_region_guard &&o ) noexcept : _c( base::exchange( o._c, nullptr ) ) {}
		...
		~clip_region_guard( void ) { if ( _c ) _c->pop_clip_rect(); }
	};
	...
	public:
		...
		render_guard( render_guard &&o ) noexcept : _c( base::exchange( o._c, nullptr ) ) {}
		...
		~render_guard( void ) { if ( _c ) _c->release(); }
	};
