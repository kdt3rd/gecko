...
LRESULT CALLBACK WndProc( HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam )
{
    ...
    switch ( msg )
    {
        ...
        case WM_SIZING:
        {
            ...
            if ( insizemove && sizemovergn.left != sizemovergn.right &&
        ...
        default: retval = DefWindowProc( hwnd, msg, wParam, lParam ); break;
    }
...
void dispatcher::remove_window( const std::shared_ptr<window> &win )
{
...
bool dispatcher::dispatch_evt( const evt &e )
{
    HWND   hwnd = e.hwnd;
    UINT   msg  = e.msg;
    WPARAM wp   = e.wp;
    ...
    switch ( msg )
    {
        ...
        case WM_CLOSE:
            if ( w->process_event( event::window(
                     _ext_events.get(),
        ...
        case WM_DESTROY: _windows.erase( w->id() ); return true;
...
void dispatcher::send_mouse_evt(
    ...
    LPARAM                         lp )
{
    ...
    w->process_event( event::mouse( _mouse.get(), e, p.x, p.y, button, mods ) );
}
