...
selection::selection( selection_type st, const std::string &s, const std::string &customSelType )
	: _data( s.begin(), s.end() ), _data_type( "text/plain;charset=utf-8" ),
	  _type( st ), _custom_selection_name( customSelType )
{
}
...
selection::selection( selection_type st,
	...
	: _data( data ), _data_type( mime_type ), _avail_mime( avail_mime ),
...
const std::string &
selection::current_mime_type( void ) const
{
...
selection::as( const std::string &mime_type )
{
