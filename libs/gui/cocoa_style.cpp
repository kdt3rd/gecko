...
base::gradient grad1{
    { 0.00, { 1.0000, 1.0000, 1.0000 } }, { 0.22, { 1.0000, 1.0000, 1.0000 } },
    { 0.56, { 0.9255, 0.9255, 0.9255 } }, { 0.72, { 0.9255, 0.9255, 0.9255 } },
    { 0.83, { 0.9294, 0.9294, 0.9294 } }, { 0.94, { 0.9373, 0.9373, 0.9373 } },
    { 1.00, { 0.9490, 0.9490, 0.9490 } },
};

gui::color     border2{ 0.3059, 0.2863, 0.4314 };
base::gradient grad2{
    { 0.00, { 0.7804, 0.8039, 0.8275 } }, { 0.06, { 0.6784, 0.7059, 0.7608 } },
    { 0.50, { 0.5176, 0.5647, 0.6510 } }, { 0.56, { 0.4549, 0.5098, 0.6157 } },
...
{
    _default_font =
        application::current()->get_font( "Lucida Grande", "Regular", 14.0 );
    postcondition( bool( _default_font ), "font for cocoa style not found" );

    _default_bold_font =
        application::current()->get_font( "Lucida Grande", "Bold", 14.0 );
    postcondition(
        bool( _default_bold_font ), "font for cocoa bold style not found" );
}
...
void cocoa_style::line_edit_frame(
...
coord cocoa_style::slider_size( const rect &rect ) { return rect.radius(); }

////////////////////////////////////////

void cocoa_style::slider_groove(
...
void cocoa_style::slider_button(
