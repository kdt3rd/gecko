...
public:
	label( void );
	label( std::string l, base::alignment a = base::alignment::LEFT, const gl::color &c = { 1.0, 1.0, 1.0, 1.0 }, const std::shared_ptr<script::font> &f = application::current()->get_default_font() );
	~label( void );
