...
public:
    ...
    istream open_read(
        const base::uri &       path,
        std::ios_base::openmode m = file_system::file_read_mode ) override;
    ostream open_write(
        const base::uri &       path,
        std::ios_base::openmode m = file_system::file_write_mode ) override;
    iostream open(
        const base::uri &       path,
        std::ios_base::openmode m =
            ( file_read_mode | file_write_mode ) ) override;
