...
public:
    ...
    static size_tagged_string
    create( string_pool &p, const char *src, size_t len );
...
public:
    ...
    {
        return size_tagged_string::create(
            *this, s, static_cast<size_t>( end - s ) );
    }
    ...
    std::pair<size_t, size_t> clear( void ) { return _strings.clear(); }
