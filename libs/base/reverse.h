...
public:
    const_reverse_wrapper( const Cont &cont ) : _container( cont ) {}
...
public:
    reverse_wrapper( Cont &cont ) : _container( cont ) {}
    ...
    decltype( _container.rend() ) end( void ) { return _container.rend(); }
};
