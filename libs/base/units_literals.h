...
#    error                                                                     \
        "Do not include units_literals.h by itself, meant as a helper for units.h"
#endif
...
constexpr inline units::meters<unsigned long long int>
operator"" _km( unsigned long long int x )
{
...
constexpr inline units::meters<unsigned long long int>
operator"" _m( unsigned long long int x )
{
...
constexpr inline units::centimeters<unsigned long long int>
operator"" _cm( unsigned long long int x )
{
...
constexpr inline units::millimeters<unsigned long long int>
operator"" _mm( unsigned long long int x )
{
...
constexpr inline units::inches<unsigned long long int>
operator"" _in( unsigned long long int x )
{
