...
inline constexpr bool ratio::valid( void ) const { return _den != 0; }

inline constexpr int64_t ratio::numerator( void ) const { return _num; }

inline constexpr int64_t ratio::denominator( void ) const { return _den; }
...
inline constexpr int64_t ratio::trunc( void ) const { return _num / _den; }

inline constexpr int64_t ratio::mod( void ) const { return _num % _den; }
