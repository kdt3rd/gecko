...
template <typename H, typename... T> constexpr inline H sum( H h, T... t )
{
    return h + sum<T...>( t... );
}

/// @brief End of recursive sum
template <typename H> constexpr inline H sum( H h ) { return h; }

////////////////////////////////////////

/// @brief Return the nth variadic type
template <size_t N, typename... Args> struct nth_variadic
{
...
template <size_t len, typename... T> struct aligned_union
{
    static constexpr size_t alignment_value =
        static_max<0, alignof( T )...>::value;
    typedef typename std::aligned_storage<
        static_max<len, sizeof( T )...>::value,
...
///
/// @{
template <size_t... S> struct sequence
{
    template <size_t X> using cons = sequence<X, S...>;
};
...
template <size_t... S> struct gen_sequence<0, S...> : sequence<S...>
{
...
struct make_int_sequence : make_int_sequence<N - 1, N - 1, I...>
{};
template <int... I> struct make_int_sequence<0, I...> : int_sequence<I...>
{
...
template <typename... Types> struct type_list
{
    ...
    template <typename... MoreTypes> struct add
    {
...
{
    static_assert(
        I < sizeof...( RestTypes ) + 1 + Offset,
        "index for type out of bounds" );
    using type = typename std::conditional<
        I == Offset,
        T,
        typename type_list_get<type_list<RestTypes...>, I, Offset + 1>::type>::
        type;
};

template <size_t I, size_t N> struct type_list_get<type_list<>, I, N>
{
    using type = void;
};

template <size_t I> struct type_list_get<type_list<>, I, 0>
{};

#if __cplusplus >= 201402L
template <typename T, size_t I>
using type_list_get_t = typename type_list_get<T, I>::type;
#endif
...
template <int N>
struct is_placeholder<base::placeholder_template<N>>
