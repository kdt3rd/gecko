...
void thread_pool::queue_delayed(
    const std::function<void( void )> &f, double seconds )
{
    ...
    auto queue_time = steady_clock::now() +
                      duration_cast<steady_clock::duration>( wait_time );
