...
public:
    /// @brief Constructor.
    explicit scope_guard( function f ) : _f( std::move( f ) ), _active( true )
    {}
    ...
    void dismiss( void ) { _active = false; }
...
template <class function> scope_guard<function> make_guard( function f )
{
...
#define on_scope_exit                                                          \
    auto ANONYMOUS_VARIABLE( SCOPE_EXIT_STATE ) =                              \
        ::base::detail::scope_guardOnExit() += [&]( void )
