...
public:
    ...
    constexpr standard_definition( const standard_definition & ) noexcept =
        default;
    standard_definition &
    operator=( const standard_definition & ) noexcept                = default;
    ...
    constexpr standard_definition(
        ...
        , _black_lum( black )
        , _peak_lum( luminance )
        , _oetf_curve( oetf_crv )
        , _eotf_curve( eotf_crv )
        , _chroma_space( chromaTransform )
        , _rendering( renderingFunc )
    {}
    ...
    constexpr state
    capture_state( range r = range::FULL, bool isRGB = true ) const
    {
        return state(
            isRGB ? space::RGB : chroma_space(),
            _chroma,
            _peak_lum,
            state::value_type( 0 ),
            r,
    ...
    constexpr state
    display_state( range r = range::FULL, bool isRGB = true ) const
    {
        return state(
            isRGB ? space::RGB : chroma_space(),
            _chroma,
...
template <standard s> constexpr standard_definition make_standard( void )
{
...
constexpr standard_definition make_standard( standard s )
{
    return (
        s == standard::SRGB
            ? make_standard<standard::SRGB>()
            : ( s == standard::BT_601_NTSC
                    ? make_standard<standard::BT_601_NTSC>()
                    : ( s == standard::BT_601_PAL
                            ? make_standard<standard::BT_601_PAL>()
                            : ( s == standard::BT_709
                                    ? make_standard<standard::BT_709>()
                                    : ( s == standard::BT_2020
                                            ? make_standard<standard::BT_2020>()
                                            : ( s == standard::BT_1886
                                                    ? make_standard<
                                                          standard::BT_1886>()
                                                    : ( s == standard::
                                                            ...
                                                            : ( s == standard::
                                                                    ...
                                                                    : ( s == standard::
                                                                            ...
                                                                            ? make_standard<
                                                                                  standard::
                                                                                      ACES_v1_0_3>()
                                                                            : ( s == standard::DCI_P3 ? make_standard<
                                                                                                            standard::
                                                                                                                DCI_P3>()
                                                                                                      : (
                                                                                                            s == standard::DCI_P3_D65 ? make_standard<standard::DCI_P3_D65>() : ( s == standard::SONY_SLOG ? make_standard<standard::SONY_SLOG>() : ( s == standard::SONY_SLOG_CINE ? make_standard<standard::SONY_SLOG_CINE>() : ( s == standard::ARRI_WIDE_GAMUT ? make_standard<standard::ARRI_WIDE_GAMUT>() : throw std::invalid_argument( "unknown color standard enum" ) ) ) ) ) ) ) ) ) ) ) ) ) ) );
}
