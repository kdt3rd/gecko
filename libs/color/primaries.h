...
namespace two_deg
{
template <typename T> inline constexpr chromaticities<T> ACES_AP0( void )
{
...
template <typename T> inline constexpr chromaticities<T> ACES_AP1( void )
{
    return chromaticities<T>(
...
template <typename T> inline constexpr chromaticities<T> Rec_601_NTSC( void )
{
    return chromaticities<T>(
...
template <typename T> inline constexpr chromaticities<T> Rec_601_PAL( void )
{
    return chromaticities<T>(
...
template <typename T> inline constexpr chromaticities<T> Rec_709( void )
{
    return chromaticities<T>(
...
template <typename T> inline constexpr chromaticities<T> Rec_2020( void )
{
    return chromaticities<T>(
...
template <typename T> inline constexpr chromaticities<T> P3_D60( void )
{
    return chromaticities<T>(
...
template <typename T> inline constexpr chromaticities<T> P3_D65( void )
{
    return chromaticities<T>(
        chroma_coord<T>( T( 0.6800 ), T( 0.32000 ) ),
        chroma_coord<T>( T( 0.26500 ), T( 0.69000 ) ),
...
template <typename T> inline constexpr chromaticities<T> P3_DCI( void )
{
    return chromaticities<T>(
        chroma_coord<T>( T( 0.6800 ), T( 0.32000 ) ),
        chroma_coord<T>( T( 0.26500 ), T( 0.69000 ) ),
...
template <typename T> inline constexpr chromaticities<T> ARRI_Alexa_WCG( void )
{
    return chromaticities<T>(
...
template <typename T> inline constexpr chromaticities<T> SONY_SGamut( void )
{
    return chromaticities<T>(
...
/// ProPhoto RGB
template <typename T> inline constexpr chromaticities<T> ROMM( void )
{
    return chromaticities<T>(
